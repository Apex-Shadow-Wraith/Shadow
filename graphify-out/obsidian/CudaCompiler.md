...
- [[._check_gpu()]] - `method` [EXTRACTED]
- [[.compile()_2]] - `method` [EXTRACTED]
...
- [[.test_detects_gpu_absent()]] - `calls` [INFERRED]
- [[.test_detects_gpu_available()]] - `calls` [INFERRED]
...
- [[Handler for compiling and executing CUDA code via nvcc.      Supports two modes]] - `rationale_for` [EXTRACTED]
